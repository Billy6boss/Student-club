...
public class ClubExportPDF6 {
  ...
  //建立不同系所之頁碼陣列集合{5,1,8}表示共有三組系所組，總頁數分
    ...
    private List<ClubSelection> cslist = null;
                ...
                if (max>0){
                   ...
                   // 課程科目迴圈------------------------------------------------- 
                    for (int i=0;i<max;i++){
                    	...
                    	datatable.addCell(this.addNewCell(cslist.get(i).getCs_num().toString(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    	datatable.addCell(this.addNewCell(cslist.get(i).getClub().getClub_name(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    	datatable.addCell(this.addNewCell(cslist.get(i).getStaff().getStaff_cname(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    	datatable.addCell(this.addNewCell(cslist.get(i).getClubSem().getClub_room(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    	datatable.addCell(this.addNewCell(cslist.get(i).getCs_lower_limit().toString(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    	datatable.addCell(this.addNewCell(cslist.get(i).getTotal_limit().toString(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    	datatable.addCell(this.addNewCell("", f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
...
public void setHeaderString(String mat_cname, String adg_cname , String dep_cname){
    String header =  this.title+" "+mat_cname+" "+ adg_cname +" " + dep_cname;
...
private PdfPTable setHeader()throws Exception{ 
    ...
    //step3:建立表格
    float headerwidths[] = {8,14,14,32,8,8,14};
    Table tablep = new Table(7);
  ...
  //step5:列印選
    	//編號
    	beanTable.addCell(this.addNewCell("編號", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0, 0.1f, 0.1f, 0.1f,0.1f));
        //社團名稱
        beanTable.addCell(this.addNewCell("社團名稱", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //指導老師
        beanTable.addCell(this.addNewCell("指導老師", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0, 0.1f, 0.1f, 0.1f,0.1f));
        //地點
        beanTable.addCell(this.addNewCell("地點", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //開放人數
        beanTable.addCell(this.addNewCell("開放人數", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //總人數
        beanTable.addCell(this.addNewCell("總人數", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //備註
        beanTable.addCell(this.addNewCell("備註", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0,  0.1f, 0.1f, 0.1f,0.1f));
    return beanTable;
}

public void setCslist(List<ClubSelection> cslist) {
	this.cslist = cslist;
}
