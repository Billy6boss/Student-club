...
public class ClubExportPDF9 {
  ...
  //建立不同系所之頁碼陣列集合{5,1,8}表示共有三組系所組，總頁數分
    ...
    private List<ClubTeaching> ctlist = null;
...
public void openDocument(HttpServletResponse response) throws Exception{  
   ...
   f_title2 = new Font(bfChinese,48,Font.HELVETICA);
...
private void setonTable()throws Exception{ 
    ...
    Color hcolor  = new java.awt.Color(255,255,255);//color
        ...
        //副標題
        beanTable.addCell(this.addNewCell("聘		書", f_title2, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //導師姓名    
        beanTable.addCell(this.addNewCell("茲敦聘書  " + ctlist.get(0).getStaff().getStaff_cname()+"	老師", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //學年度  + 學期          
        beanTable.addCell(this.addNewCell("擔任    "+ctlist.get(0).getSbj_year()+"	學年" +( (ctlist.get(0).getSbj_sem() == '1')? "  第  一  學期" : "  第  二  學期"), f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_col2, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //學校
        beanTable.addCell(this.addNewCell(schname, f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //社團
        beanTable.addCell(this.addNewCell(ctlist.get(0).getClub().getClub_name()+"		指導老師", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //內容
        beanTable.addCell(this.addNewCell("此		聘", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
...
public void setCtlist(List<ClubTeaching> ctlist) {
	this.ctlist = ctlist;
}
