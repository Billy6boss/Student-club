                   ...
                   // 課程科目迴圈------------------------------------------------- 
                    for (int i=0;i<max;i++){
                    	...
                    	if(cmlist.get(i).getRgno() != checkrgno) {
                    		...
                    		datatable.addCell(this.addNewCell(cmlist.get(i).getClub().getClub_name(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    		datatable.addCell(this.addNewCell(cmlist.get(i).getRgno().toString(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    		datatable.addCell(this.addNewCell(cmlist.get(i).getStuRegister().getStuBasis().getCname(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    		datatable.addCell(this.addNewCell((cmlist.get(i).getStuRegister().getStuBasis().getSex() == 1) ? "男" : "女" , f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    		datatable.addCell(this.addNewCell(cadrename, f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
                    		datatable.addCell(this.addNewCell(cmlist.get(i).getClub_score().toString(), f_content, Element.ALIGN_CENTER, 5, null, span_count, 0, 0, 0.1f, 0.1f, 0.1f, 0.1f));
...
private PdfPTable setHeader()throws Exception{ 
    ...
    //step3:建立表格
    float headerwidths[] = {16,16,16,12,20,16};
  ...
  //step5:列印選
    	//班級
    	beanTable.addCell(this.addNewCell("班級", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0, 0.1f, 0.1f, 0.1f,0.1f));
        //座號
        ...
        //成績
        beanTable.addCell(this.addNewCell("成績", f_col, Element.ALIGN_CENTER, 5, hcolor, 0, 0, 0,  0.1f, 0.1f, 0.1f,0.1f));        
    return beanTable;
}
