...
private void setonTable()throws Exception{ 
    ...
    Color hcolor  = new java.awt.Color(255,255,255);//color
        ...
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //導師姓名    
        beanTable.addCell(this.addNewCell("查本校  		" + cslist.get(0).getStubasis().getCname()+"		同學", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //學年度  + 學期          
        beanTable.addCell(this.addNewCell("當選    	"+cslist.get(0).getSbj_year()+"  學年", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_col2, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //學校
        beanTable.addCell(this.addNewCell("第    "+cslist.get(0).getSbj_sem()+"  學期" + cslist.get(0).getClub().getClub_name() + " 績優社員", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        
        beanTable.addCell(this.addNewCell(" ", f_title, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
        //社團
        beanTable.addCell(this.addNewCell(" ", f_col3, Element.ALIGN_CENTER, 5, hcolor, 0, 1, 0,  0.1f, 0.1f, 0.1f,0.1f));
